...
const TITLE = "Adopt Clara";
const TAGLINE = "The Queen of the Pasture";

const gallery = [
  { src: goatIcon2, alt: "Clara standing on a straw bale like she owns the barn" },
  { src: goatIcon1, alt: "Clara giving the camera her full attention" },
  { src: goatIcon3, alt: "Clara being held by a visitor during cuddle time" },
];

const silverItems = [
  "Digital certificate of adoption",
  "A digital info package about Clara (photo, traits, and species details)",
  "Two updates per year on Clara",
];
...
const goldItems = [
  ...
  "A digital info package about Clara (photo, traits, and species details)",
  "Two updates per year on Clara",
  "A 15m Zoom call with Clara",
];

const importantInfo = [
  "Adoptions are symbolic and do not transfer ownership of the animal.",
  "All adoption contributions are non-refundable and go directly toward Clara's care.",
...
export const Route = createFileRoute("/adopt-an-animal/clara")({
  head: () => ({
    meta: [
      { title: `${TITLE} | Udderly Ridiculous Farm Life` },
      { name: "description", content: `Symbolically adopt Clara, ${TAGLINE.toLowerCase()}, and support her care at Udderly Ridiculous Farm Life.` },
      { property: "og:title", content: `${TITLE} — ${TAGLINE}` },
      { property: "og:description", content: `Symbolically adopt Clara, ${TAGLINE.toLowerCase()}, and support her care at Udderly Ridiculous Farm Life.` },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
  }),
  component: AdoptClaraPage,
});

function AdoptClaraPage() {
  return (
    <div className="min-h-screen bg-background text-body-copy">
      ...
      <main id="top">
        ...
        <section className="relative isolate flex min-h-[68vh] items-center justify-center overflow-hidden">
          ...
          <div className="mx-auto max-w-4xl px-5 py-24 text-center md:px-8 md:py-32">
            <h1 className="font-display text-[clamp(2.6rem,8vw,7rem)] font-black uppercase leading-[0.82] text-background">
              Adopt <span className="text-secondary-accent">Clara</span>
            </h1>
            ...
            <div className="grid items-start gap-14 lg:grid-cols-[1.05fr_1fr]">
              ...
              <div>
                <h2 className="font-display text-[clamp(2.6rem,6vw,5rem)] font-black uppercase leading-[0.82] text-headline">
                  Meet<br /><span className="text-stroke">Clara.</span>
                </h2>
                <p className="mt-6 text-base leading-relaxed md:text-lg">
                  Placeholder description. Clara is the undisputed ruler of the pasture, a goat with opinions, eyebrows, and a personal vendetta against any gate that dares stay closed. She leads with her horns held high, investigates every pocket like it might contain a snack, and has never met a human she did not immediately try to climb.
                </p>
                <p className="mt-4 text-base leading-relaxed md:text-lg">
                  Placeholder description. By adopting Clara, you are not just sponsoring a goat — you are joining the royal court. You will receive updates on her latest schemes, photos of her best side (she insists it is all of them), and the quiet pride of knowing the Queen has noticed you.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* 4. Adoption packages */}
        <section id="adopt-clara" className="overflow-hidden bg-farm-beige py-20 md:py-28">
          <div className="mx-auto max-w-[1200px] px-5 md:px-8">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-center text-lg leading-relaxed">
              Two ways to support Clara. Both come with bragging rights.
            </p>
            ...
            <div className="mt-14 grid gap-8 lg:grid-cols-2">
              ...
              <article className="relative flex flex-col border-2 border-headline bg-farm-silver p-1 shadow-[12px_12px_0_var(--headline)] transition-transform duration-300 hover:-translate-y-2">
                ...
                <div className="flex flex-1 flex-col p-6 pt-8 md:p-8 md:pt-10">
                  ...
                  <Button asChild size="large" className="mt-8 w-full">
                    <a href="#adopt-clara">Adopt Clara — Silver <ArrowRight aria-hidden="true" /></a>
                  </Button>
                </div>
              </article>
              ...
              <article className="relative flex flex-col border-2 border-headline bg-farm-gold p-1 shadow-[12px_12px_0_var(--headline)] transition-transform duration-300 hover:-translate-y-2">
                ...
                <div className="flex flex-1 flex-col p-6 pt-8 md:p-8 md:pt-10">
                  ...
                  <Button asChild size="large" className="mt-8 w-full">
                    <a href="#adopt-clara">Adopt Clara — Gold <ArrowRight aria-hidden="true" /></a>
                  </Button>
                </div>
              </article>
            </div>
          ...
          <div className="mx-auto grid max-w-[1300px] items-center gap-8 px-5 md:px-8 lg:grid-cols-2 lg:gap-14">
            <div>
              <h2 className="font-display text-[clamp(2.8rem,8vw,6rem)] font-black uppercase leading-[0.78] text-headline">
                Your adoption<br />keeps Clara royal.
              </h2>
              <div className="mt-8 flex flex-col border-2 border-headline bg-background p-7 text-left shadow-[12px_12px_0_var(--headline)] md:p-9">
                <p className="text-base leading-relaxed md:text-lg">
                  Placeholder description. Every adoption directly funds high-quality feed, clean bedding, routine veterinary care, enrichment toys, and the occasional crown-shaped snack. It also helps us rescue and rehabilitate new animals who need a safe place to land.
                </p>
                <p className="mt-4 text-base leading-relaxed md:text-lg">
                  Placeholder description. This is not a one-time gift — it is a year-long partnership that keeps Clara happy, healthy, and appropriately ridiculous.
                </p>
              </div>
            </div>
            ...
            <figure>
              <img
                src={goatIcon3}
                alt="Clara being held by a visitor during cuddle time"
                width={1024}
                height={1024}
                loading="lazy"
